...
#ifndef __typesForCMSIS
#define __typesForCMSIS
typedef enum IRQn {
...
#define NVMCTRL_INSTS                                                                                                                                                                                  \
    { NVMCTRL } /**< \brief (NVMCTRL) Instances List */
...
#define OSCCTRL_INSTS                                                                                                                                                                                  \
    { OSCCTRL } /**< \brief (OSCCTRL) Instances List */
...
#define PUKCC_INSTS                                                                                                                                                                                    \
    { PUKCC } /**< \brief (PUKCC) Instances List */
...
#define TC_INSTS                                                                                                                                                                                       \
    { TC0, TC1, TC2, TC3, TC4, TC5 } /**< \brief (TC) Instances List */
